...
namespace HermesChatApp.Hubs
{
    ...
    {
        private static readonly List<HubUser> ConnectedUsers = new List<HubUser>();
        private static readonly MessageDictionary MessageDictionary = new MessageDictionary();
        private static readonly GroupDictionary GroupDictionary = new GroupDictionary();
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            await Clients.All.SendAsync("RecieveOnlineGroups", GroupDictionary.GetListOfGroups());
        ...
        public override async Task OnDisconnectedAsync(Exception? exception)
        {
            ...
            GroupDictionary.RemoveUserFromGroup(hubUser);
            await Clients.All.SendAsync("RecieveOnlineGroups", GroupDictionary.GetListOfGroups());
            await Clients.All.SendAsync("RecieveOnlineUsers", ConnectedUsers);           
        ...
        public async Task JoinPrivateChat(string toUser)
        {
            ...
            var messageList = MessageDictionary.GetLastMessageList(groupName);
        ...
        public async Task SendPrivateMessage(string toUser, string message)
        {
            ...
            MessageDictionary.Add(groupName, saveMessage);
        ...
        public async Task CreateGroup(string groupName)
        {
            ...
            //add to dictionary
            GroupDictionary.Add(groupName, hubUser);
            
            await Groups.AddToGroupAsync(Context.ConnectionId, groupName);
            await Clients.All.SendAsync("RecieveOnlineGroups", GroupDictionary.GetListOfGroups());
            //add him immediatly to this chat
            if (hubUser.UserIdentifier != null)
        ...
        public async Task LeaveRoom(string groupName)
        {
            ...
            GroupDictionary.Remove(groupName, hubUser);
            await Clients.All.SendAsync("RecieveOnlineGroups", GroupDictionary.GetListOfGroups());
